...
estados VARCHAR(15) NOT NULL DEFAULT 'pendiente' CHECK (estados IN ('pendiente', 'en_progreso', 'completada', 'cancelada')),
id_usuario INT NOT NULL REFERENCES usuarios(id_usuario),
id_evento INT NOT NULL REFERENCES eventos(id_evento) --Correjido
);
...
-- Vista para RF-10: ranking de ocupación de ubicaciones 
